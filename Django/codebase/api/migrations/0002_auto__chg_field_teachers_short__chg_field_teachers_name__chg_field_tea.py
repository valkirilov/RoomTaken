...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Teachers.short'
        db.alter_column(u'api_teachers', 'short', self.gf('django.db.models.fields.CharField')(default=0, max_length=5))

        # Changing field 'Teachers.name'
        db.alter_column(u'api_teachers', 'name', self.gf('django.db.models.fields.CharField')(default=0, max_length=30))

        # Changing field 'Teachers.degree'
        db.alter_column(u'api_teachers', 'degree', self.gf('django.db.models.fields.CharField')(default=0, max_length=16))

    def backwards(self, orm):

        # Changing field 'Teachers.short'
        db.alter_column(u'api_teachers', 'short', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

        # Changing field 'Teachers.name'
        db.alter_column(u'api_teachers', 'name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Teachers.degree'
        db.alter_column(u'api_teachers', 'degree', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))
