...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'api_teachers', 'name', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'Teachers.name'
        db.alter_column(u'api_teachers', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
