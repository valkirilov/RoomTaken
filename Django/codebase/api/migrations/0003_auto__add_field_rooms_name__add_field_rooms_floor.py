...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rooms.name'
        db.add_column(u'api_rooms', 'name',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=32),
                      keep_default=False)

        # Adding field 'Rooms.floor'
        db.add_column(u'api_rooms', 'floor',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=7),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rooms.name'
        db.delete_column(u'api_rooms', 'name')

        # Deleting field 'Rooms.floor'
        db.delete_column(u'api_rooms', 'floor')
